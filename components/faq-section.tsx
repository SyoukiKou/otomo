...
const faqs = [
  {
    question: "音大生でなくても相談できますか？",
    answer: "はい、音楽を学んでいる方であれば大歓迎です。専門学校生、音楽教室に通っている方、卒業後数年経った方なども対象です。音楽とキャリアの両立に悩んでいる方であれば、ぜひご相談ください。"
  },
  {
    question: "どんな内容を相談できますか？",
    answer: "「音楽を続けるか就職するか迷っている」「就活の進め方がわからない」「音大生の強みが何かわからない」「将来が漠然と不安」など、キャリアに関することなら何でもお話しいただけます。答えを押し付けるのではなく、一緒に考える時間にしたいと思っています。"
  },
  {
